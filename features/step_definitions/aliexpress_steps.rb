...
Then(/^the user verifies the amount of products in stock to be greater or equal to 2$/) do
  expect(ali_express_product_page.buy_now_button).to be_visible
  expect(ali_express_product_page.buy_now_button.disabled?).to eq false
end
